  ...
  return (
    ...
    <section className='mt-50'>
      <div id="container">
        ...
        <p id='subtext' className='text-muted-foreground px-7 text-center'>Our customers love our professional delivery and customer service and here's why.</p>
      </div>
      <p className='underline text-center pt-10 text-2xl text-[#ed9e59]'>
        SEE MORE REVIEWS
      </p>
      <div className='h-dvh my-15'>
        <img
        ...
        {isMobile ? (
          ...
          <CarouselContent className='mt-30'>
            ...
            <CarouselItem key={name} className='px-20'>
    ...
    <section id='value-container' className='px-10'>
      <div className='flex md:item-row item-col gap-13 md:gap-5 w-full'>
        {VALUE_PROPS.map(({title, description, icon},index) => (
          <Card id='value-cards' key={index} className='border-[#ed9e59] md:w-1/2 border-1 px-10 py-5 gap-2'>
